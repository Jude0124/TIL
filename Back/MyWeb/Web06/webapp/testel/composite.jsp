...
--%>
<%--실행시 해제 <%@ taglib prefix="my" uri="http://tomcat.apache.org/example-taglib" %> --%>
...
<html>
  ...
  <body>
    ...
    <jsp:useBean id="values" class="com.test.ValuesBean" />
    ...
    <blockquote>
      ...
      <tr>
        <td>\${'hello'} wo\${'rld'}</td>
        <td>String</td>
        <td><jsp:setProperty name="values" property="stringValue"
        		 value="${'hello'} wo${'rld'}"/>${values.stringValue}</td>
      </tr>
      <tr>
        <td>\${'hello'} wo\${'rld'}</td>
        <td>String</td>
